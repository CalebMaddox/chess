class Game {
  constructor(startingPosition) {
    ...
    this.currentDots = [];
    this.history = [{ position: this.startingPosition, highlighted: [] }];
  ...
  testSequentialMove(destination, player) {
  ...
  checkIfAttacked(spot, player) {
    ...
    piecesToIterate.forEach((piece, index) => {
      if (!yetAttacked) {
        ...
        console.log(numToLetter(spot.file), piece, spotsToCheck);
